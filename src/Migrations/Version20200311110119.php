 ...
 */
final class Version20200311110119 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE colis ADD path VARCHAR(255) DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE colis DROP path, CHANGE user_id user_id INT DEFAULT NULL');
