 ...
 */
final class Version20200311084726 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE colis ADD image VARCHAR(255) NOT NULL, CHANGE user_id user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE colis DROP image, CHANGE user_id user_id INT DEFAULT NULL');
